...
echo_output "Searching for \"Level_1_Raw/${Project_code}/s*/g*/m*/calibrated.ms\" ..."
list_files=($(find "Level_1_Raw/${Project_code}" -mindepth 5 -maxdepth 5 -type d -name "calibrated.ms"))
if [[ ${#list_files[@]} -eq 0 ]]; then
    echo_output "Searching for \"Level_1_Raw/${Project_code}/s*/g*/m*/uid__*.ms\" ..."
    list_files=($(find "Level_1_Raw/${Project_code}" -mindepth 5 -maxdepth 5 -type d -name "uid__*.ms"))
fi
if [[ ${#list_files[@]} -eq 0 ]]; then
    echo_output "Searching for \"Level_1_Raw/${Project_code}/s*/g*/m*/uid__*.ms.split.cal\" ..."
